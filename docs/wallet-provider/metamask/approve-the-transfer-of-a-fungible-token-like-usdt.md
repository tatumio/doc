...
const txId: string = await tatum.walletProvider.metaMask.approveErc20('0x4675C7e5BaAFBFFbca748158bEcBA61ef3b0a263', '1.5', USDT)
...
(async () => {
  try {
    ...
    const txId = await tatum.walletProvider.metaMask.approveErc20('0x4675C7e5BaAFBFFbca748158bEcBA61ef3b0a263', '1.5', USDT);
    console.log(txId);
  } catch (error) {
