...
{% hint style="warning" %}
There was Arbitrum hard-fork from Classic to Nitro. As the results of this, you are able to use **debug** methods from block 22 207 818 to the actual one. For older blocks (pre-nitro) please use method **arbtrace\_call** or **arbtrace\_callMany** instead of **debug\_traceCall**.
{% endhint %}
