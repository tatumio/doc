...
const tx = await tatum.rpc.getTransactionByBlockHashAndIndex('0xcb632c914a18d838113f1e0cbf3ebc58e837c9497113c247001ecd52b212768e', 0)
...
The `klay_getTransactionByBlockHashAndIndex` method accepts two parameters:
