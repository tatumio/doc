...
1. **`blockHash`**: The hash of the block you want to retrieve information about.
   * Type: `String`
   * Example: `"0x20338a164dfb8f23d067df87fe0fb89a9248b2071ec2e91ac0383f5c0b1fb13d"`
...
```json
{
  ...
  "params": ["0x20338a164dfb8f23d067df87fe0fb89a9248b2071ec2e91ac0383f5c0b1fb13d", true],
  "id": 1
}
```
